...
@implementation StatusScreen1DS

static NSString *const kUrl             = @"https://ibm-pods.buildup.io";
static NSString *const kApiKey          = @"Eq0PGMdh";
static NSString *const kResourceId      = @"/app/5806036fab75b70300027919/r/statusScreen1DS";
...
- (instancetype)init {
    ...
    self = [super initWithUrlString:kUrl 
                       ...
                       objectsClass:[StatusScreen1DSItem class]];
    if (self) {
...
- (NSArray *)searchableFields {
    ...
    return @[kStatusScreen1DSItemStatus, kStatusScreen1DSItemEmployee, kStatusScreen1DSItemId];
}
